...
type ConfYaml struct {
	...
	OpenStackConfig OpenStackConfig `yaml:"openstack"`
}
...
func (c *Config) initConfig() (ConfYaml, error) {
	...
	if err := viper.ReadInConfig(); err != nil {
		...
		Log.Info(viper.GetString("core.name"))
	}
	...
	confYaml.Core.Address = viper.GetString("core.address")
	...
	//OpenStack
	confYaml.OpenStackConfig.User = viper.GetString("openstack.User")
	confYaml.OpenStackConfig.IdentityEndpoint = viper.GetString("openstack.IdentityEndpoint")
	confYaml.OpenStackConfig.DomainName = viper.GetString("openstack.DomainName")
	confYaml.OpenStackConfig.PassWord = viper.GetString("openstack.PassWord")
	confYaml.OpenStackConfig.Region = viper.GetString("openstack.Region")
	confYaml.OpenStackConfig.TenantName = viper.GetString("openstack.TenantName")
